...
// major more more
    ...
    //example test jedna wpadka  (wysokość kontraktu, oczekiwany wynik) - not necessary (is included above)
    ...
    //test for contract nt on level 3 with missing p - not necessary (is included above)
