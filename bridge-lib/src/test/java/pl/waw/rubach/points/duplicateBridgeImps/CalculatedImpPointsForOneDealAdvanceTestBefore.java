...
public class CalculatedImpPointsForOneDealAdvanceTestBefore {
  ...
  private final MultiKeyMap<Integer, Integer> testCountingPointsNTBothBeforeBothNoFit = new MultiKeyMap<>();
  private final MultiKeyMap<Integer, Integer> testCountingPointsNTBothBeforeBothFit = new MultiKeyMap<>();
