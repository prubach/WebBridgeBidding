...
public class FourGameImpScorringTest {
  ...
  private final MultiKeyMap<Integer, Integer> inputDataPointsForContract1 = new MultiKeyMap<>();
  private final MultiKeyMap<Integer, Integer> inputDataPointsForContract2 = new MultiKeyMap<>();
  private final MultiKeyMap<Integer, Integer> inputDataPointsForContract3 = new MultiKeyMap<>();
  private final MultiKeyMap<Integer, Integer> inputDataPointsForContract4 = new MultiKeyMap<>();
  private final MultiKeyMap<Integer, Integer> inputDataPointsForContract5 = new MultiKeyMap<>();
  private final MultiKeyMap<Integer, Integer> inputDataPointsForContract6 = new MultiKeyMap<>();


  private final MultiKeyMap<Integer, Integer> whoPlay1 = new MultiKeyMap<>();
  private final MultiKeyMap<Integer, Integer> whoPlay2 = new MultiKeyMap<>();
  private final MultiKeyMap<Integer, Integer> whoPlay3 = new MultiKeyMap<>();
  private final MultiKeyMap<Integer, Integer> whoPlay4 = new MultiKeyMap<>();

  //opcje                 wynik
  private final MultiKeyMap<MultiKeyMap<Integer, Integer>, Integer> testRubberFromPoints2MultiKey = new MultiKeyMap<>();
