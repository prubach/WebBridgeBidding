...
public class PredictionTest extends CalculatedImpPointsForOneDealFirstTest {
  ...
  public void testPrediction() throws BridgeException {
    ...
    for (
      ...
      logger.info("Dla " + pointsInBothHands + " pkt, jeżeli chcesz ugrać " + imps + " impów,["
          + diff + " ; " + pointsOfContractFloat + "] musisz zdobyć średnio " + pointsOfContract
          + " punktów za kontrakt. Obie przed, obie bez fitu");
