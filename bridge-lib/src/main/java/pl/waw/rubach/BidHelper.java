...
/**
 * Static class with some universal biding sets etc..
 */
public class BidHelper {
   ...
   *
   * @param desc description without colors markers
   * @return description with color markers
   */
   ...
   *
   * @param bidSuit for which we are looking symbols
   * @return suit description (symbol) in proper color
   */
