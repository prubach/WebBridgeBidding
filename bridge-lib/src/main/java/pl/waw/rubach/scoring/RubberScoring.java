...
public class RubberScoring {
    ...
    RubberScoring(int piH1,int piH2, int piH3, int piH4, int pfC1, int pfC2, int pfC3, int pfC4,
        ...
        fillMapRubberScorring(2,piH1,pfC2,fW2,fT2);
        fillMapRubberScorring(3,piH1,pfC3,fW3,fT3);
    ...
    private void fillMapRubberScorring(int contractNumber,int pointsInBothHands, int pointsForContract, boolean fitInOlderColorWe, boolean fitInOlderColorThey)
        ...
        scorringForOneGame.put(contractNumber, new ResultsOfOneGame(pointsInBothHands, pointsForContract, false, false, fitInOlderColorWe, fitInOlderColorThey));
      ...
      public static void main(String [ ] args)
    {
        ...
        try {
            RubberScoring a = new RubberScoring(20,21,22,23,0,0,0,0,false,false,false,false,false,false,false,false);
            getRubberScoringAsString(20,21,22,23,0,0,0,0,false,false,false,false,false,false,false,false);
